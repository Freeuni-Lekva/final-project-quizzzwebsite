...
<div class="main_class">
    ...
    <div class="panelBody">
        ...
        <form  action="quiz.QuizCreationServlet" method="post">
            ...
            <div class="questionCreation">
                ...
                <button type="button"  onclick="addFillInQuestion()">add fill in quiz.question</button>
                <button type="button"   onclick="addMultipleChoiceQuestion()">add multiple choice quiz.question</button>
                <button type="button"   onclick="addPictureResponseQuestion()">add picture response quiz.question</button>
                <button type="button"  onclick="addResponseQuestion()">add response quiz.question</button>
                ...
                <script>
                    ...
                    function addFillInQuestion()
                    {
                        ...
                        document.getElementById('response').innerHTML+='<h4>Fill In Questions</h4>'+'<br/>Input quiz.question text and make  gap with "~"  symbol <input type="text" name="'+boxName+"11"+'"/><br>Input correct answers delimited with "~" symbol <input type="text" name="'+boxName+"21"+'"/><br/>';
                        countBox += 1;
                    }
                    function addMultipleChoiceQuestion()
                    {
                        var boxName="textBox"+countBox;
                        document.getElementById('response').innerHTML+='<h4>Multiple Choice Questions</h4>'+'<br/>Input quiz.question text  <input type="text" name="'+boxName+"12"+'"/><br>Input correct answers delimited with "~" symbol <input type="text" name="'+boxName+"22"+'"/><br>Input probable answers delimited with "~" symbol <input type="text" name="'+boxName+"32"+'"/><br/>';
                        countBox += 1;
                    }
                    ...
                    {
                        var boxName="textBox"+countBox;
                        document.getElementById('response').innerHTML+='<h4>Response Question</h4>'+'<br/>Input quiz.question text <input type="text" name="'+boxName+"14"+'"/><br>Input correct answer <input type="text" name="'+boxName+"24"+'"/><br>Input probable answers delimited with "~" symbol <input type="text" name="'+boxName+"34"+'"/><br/>';
                        countBox += 1;
                    }
                </script>
